...
for i = 1:length(trainLabels)
  ...
  I = imread(['../wildhorizon/images/', name]);
  sz = size(I);
...
sordDsTrain = sordDataStore(imdsTrain, trainLabels, imSize, cropSize, doFlip, rhoClasses, thetaClasses, meanImage, useBw, Nclasses);
sordDsVal = sordDataStore(imdsVal, valLabels, imSize, cropSize, doFlip, rhoClasses, thetaClasses, meanImage, useBw, Nclasses);
sordDsTest = sordDataStore(imdsTest, testLabels, imSize, cropSize, doFlip, rhoClasses, thetaClasses, meanImage, useBw, Nclasses);


%% Save images and labels

save('sordDs', 'sordDsTrain', 'sordDsVal', 'sordDsTest', 'k');

classdef horizonRegressionLayer < nnet.layer.RegressionLayer
    ...
    methods
        function layer = horizonRegressionLayer(name, x1, x2)
        ...
        function dLdY = backwardLoss(layer, Y, T)
            ...
            for n = 1:N
              if d1(1, 1, 1, n)^2 > d2(1, 1, 1, n)^2
                  d = d1(1, 1, 1, n);
                  dLdY(1, n) = d * layer.x1 / bhat(1, 1, 1, n);
                  dLdY(2, n) = -d * (ahat(1, 1, 1, n) * layer.x1 + chat(1, 1, 1, n)) / bhat(1, 1, 1, n)^2;
                  dLdY(3, n) = d / bhat(1, 1, 1, n);
              else
                  d = d2(1, 1, 1, n);
                  dLdY(1, n) = d * layer.x2 / bhat(1, 1, 1, n);
                  dLdY(2, n) = -d * (ahat(1, 1, 1, n) * layer.x2 + chat(1, 1, 1, n)) / bhat(1, 1, 1, n)^2;
                  dLdY(3, n) = d / bhat(1, 1, 1, n);
              end
            end
            dLdY = dLdY / N;

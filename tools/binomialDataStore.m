classdef binomialDataStore < matlab.io.Datastore & ...
    ...
    methods
        ...
        function ds = binomialDataStore(imDs, inputLabels, imSize, croppedSize, horizontalFlip, ...
            rhoClasses, thetaClasses, meanImage, bw)
...
%                 'IncludeSubfolders',true);
        ...
        function data = preprocessData(ds,predictors,responses, fileIndices)
            ...
            for i = 1:miniBatchSize
                ...
                % calculate binomial labels
                rhoLabels = createBinomialLabels(rho, ds.rhoClasses);
                thetaLabels = createBinomialLabels(theta, ds.thetaClasses);
